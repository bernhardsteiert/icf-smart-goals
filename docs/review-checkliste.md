# Förderkompass – Review-Checkliste für die Fachkraft

Danke fürs Testen! Ziel dieses Reviews ist **nicht** die Technik, sondern die
**fachliche Qualität**: Stimmen Codes, Ziele, Sprache und Ablauf für den Alltag
in der Heilpädagogik? Genau das kann nur die Praxis beurteilen – und es ist jetzt
der richtige Zeitpunkt, weil sich Anpassungen (Code-Listen, Formulierungen) noch
leicht einarbeiten lassen.
...
## 5. Sprache & Tonalität
- [ ] Fachsprache stimmt (Begriffe, Formulierungen).
- [ ] Tonfall ist wertschätzend und ressourcenorientiert.
...
## 7. Merkmale & Datenschutz
- [ ] Die abgefragten Merkmale (Alter, Kontext, Einschränkungen) reichen für gute Ziele.
- [ ] Ich kam **nicht** in die Verlegenheit, einen echten Namen eintippen zu müssen.
...
## Gesamteindruck
- Würde es mir im Alltag Zeit/Arbeit sparen? (1 = gar nicht … 5 = sehr) ____
- Die **3 wichtigsten Dinge**, die noch besser werden müssten:
  1.
  2.
  3.
- Sonstiges / Wünsche:
